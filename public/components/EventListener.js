import { TOGGLE_EVENT, ADD_TO_TREE_EVENT, DELETE_FROM_TREE_EVENT, CLICK_DOCUMENT_EVENT, EDIT_DOCUMENT_EVENT, CLICK_OUTSIDE_MODAL_EVENT, EDITOR_AUTOSAVE_EVENT, } from '../constants.js';
...
class EventListener {
    constructor() {
        ...
        window.addEventListener(ADD_TO_TREE_EVENT, async (e) => {
            ...
            // change route
            onRouteChange(`/${nextDocument.parent ? `documents` : `modal`}/${nextDocument.id}`);
        });
